...
3. Install Wrangler CLI: `npm install -g wrangler` Or check out [Docs](https://developers.cloudflare.com/workers/wrangler/install-and-update/)
4. Create API token here: https://dash.cloudflare.com/profile/api-tokens
...
5. Adjust your own email in - `./src/index.js` file
